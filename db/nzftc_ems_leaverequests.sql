...
CREATE TABLE `leaverequests` (
  ...
  `LeaveType` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  ...
  `ApprovedByEmployeeId` int DEFAULT NULL,
  ...
  KEY `IX_leaverequests_StartDate_EndDate` (`StartDate`,`EndDate`),
  CONSTRAINT `FK_leaverequests_Employees_ApprovedByEmployeeId` FOREIGN KEY (`ApprovedByEmployeeId`) REFERENCES `employees` (`EmployeeId`),
  CONSTRAINT `FK_leaverequests_Employees_EmployeeId` FOREIGN KEY (`EmployeeId`) REFERENCES `employees` (`EmployeeId`) ON DELETE CASCADE
...
INSERT INTO `leaverequests` VALUES (1,1001,'Annual','2025-11-27','2025-11-27',NULL,'Approved','2025-11-25 09:09:17.371120',1001,'2025-11-25 09:09:28.480960');
