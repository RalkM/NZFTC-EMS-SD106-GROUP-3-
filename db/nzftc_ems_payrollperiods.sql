...
CREATE TABLE `payrollperiods` (
  ...
  `PeriodCode` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `PeriodStart` date NOT NULL,
  `PeriodEnd` date NOT NULL,
  `TotalAmount` decimal(14,2) NOT NULL,
  `Closed` tinyint(1) NOT NULL,
  PRIMARY KEY (`PayrollPeriodId`),
  UNIQUE KEY `IX_payrollperiods_PeriodCode` (`PeriodCode`)
...
INSERT INTO `payrollperiods` VALUES (1,'2025-M11','2025-11-01','2025-11-30',0.00,0),(2,'2025-M12','2025-12-01','2025-12-31',0.00,0),(3,'2025-FN13','2025-11-01','2025-11-14',90000.00,1);
