...
CREATE TABLE `supportmessages` (
  ...
  `Body` varchar(4000) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `SentAt` datetime(6) NOT NULL,
  `SenderIsAdmin` tinyint(1) NOT NULL,
  `AdminReply` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
  `AdminReplyAt` datetime(6) DEFAULT NULL,
  PRIMARY KEY (`Id`),
  KEY `IX_supportmessages_TicketId` (`TicketId`),
...
INSERT INTO `supportmessages` VALUES (1,1,1002,'Hi, I need help setting up my account.','2025-11-20 09:00:00.000000',0,NULL,NULL),(2,1,1001,'Admin here — your account is now active!','2025-11-20 09:05:00.000000',1,NULL,NULL);
