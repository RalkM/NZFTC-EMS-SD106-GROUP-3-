...
CREATE TABLE `supporttickets` (
  ...
  PRIMARY KEY (`Id`),
  KEY `IX_supporttickets_EmployeeId` (`EmployeeId`),
  CONSTRAINT `FK_supporttickets_Employees_EmployeeId` FOREIGN KEY (`EmployeeId`) REFERENCES `employees` (`EmployeeId`)
...
INSERT INTO `supporttickets` VALUES (1,'Welcome to Support','This is the initial seeded support ticket.',0,0,1002,1001,'2025-11-20 00:00:00.000000',NULL);
